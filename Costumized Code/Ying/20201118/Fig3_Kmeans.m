...
%% Function: K means Figure Generator Development
% Peiyu Wang
% 09/03/2020
...
SaveFigFolder = fullfile(pwd,"Images_Kmeans");
...
load("ref_struct.mat")
LT_Kmeans_IG(raw_struct,2,'No Filter',7);
LT_Kmeans_IG(med_struct,2,'Median Filter',7);
LT_Kmeans_IG(nlm_struct,2,'CNLM Filter',7);


%%

function LT_Kmeans_IG(org_struct,knum,name,noise_level)
