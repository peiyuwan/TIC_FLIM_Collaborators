%% Generate Mask For ROI plots Specify the Folder.
% Peiyu Wang
% 8/31/2020
...
data_folder = "D:\Scotts Lab\Collaborations\For Senta\20210810_Segmentation\TestData\11c-260\11c-260_1";
% Where the data is stored
z_stacks = 1;   % Number os Z_stacks
%mask_base_ch = 5; % Which detector sequence to base the mask creation on.
mask_ch = 10; % the channel number you want to create the mask on. XX according to chXX.
...
square_length =   100; % Adjust this according to your desired square length
